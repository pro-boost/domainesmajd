    ...
    <div>
      ...
      <section className="hero-section bg-charcoal-900 text-white">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.pexels.com/photos/3687927/pexels-photo-3687927.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')",
          }}
        />
          ...
          <div className="bg-white dark:bg-charcoal-800 rounded-xl shadow-lg overflow-hidden max-w-4xl mx-auto">
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-cream-200 dark:border-charcoal-700">
                    <td className="py-4 px-4 font-medium text-charcoal-800 dark:text-cream-50">
                      Hass
                    </td>
                    <td className="py-4 px-4 text-center bg-avocado-100/50 dark:bg-avocado-900/30 text-avocado-800 dark:text-avocado-400">
                      ●
                    </td>
                    <td className="py-4 px-4 text-center bg-avocado-100/50 dark:bg-avocado-900/30 text-avocado-800 dark:text-avocado-400">
                      ●
            ...
            <div className="p-4 bg-cream-50 dark:bg-charcoal-900 text-sm text-charcoal-600 dark:text-cream-300 flex gap-6">
              <div className="flex items-center gap-2">
                <span className="text-avocado-800 dark:text-avocado-400">
                  ●
                </span>
