...
const AboutPage: React.FC = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="hero-section bg-avocado-700 text-white">
        <div
          className="absolute inset-0 bg-cover bg-center opacity-20"
          style={{
            backgroundImage:
              "url('https://images.pexels.com/photos/2827374/pexels-photo-2827374.jpeg?auto=compress&cs=tinysrgb&w=1600')",
          }}
        />
            ...
            <div className="relative border-l-4 border-avocado-500 dark:border-avocado-700 ml-6 pl-12 pb-8">
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-charcoal-800 dark:text-cream-50 mb-2">
                  2010: {t("about.history.foundation")}
                </h3>
                <p className="text-charcoal-600 dark:text-cream-300">
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-charcoal-800 dark:text-cream-50 mb-2">
                  2018: {t("about.history.certification")}
                </h3>
                <p className="text-charcoal-600 dark:text-cream-300">
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-charcoal-800 dark:text-cream-50 mb-2">
                  2022: {t("about.history.innovation")}
                </h3>
                <p className="text-charcoal-600 dark:text-cream-300">
      ...
      <section className="py-16 full-height-section bg-cream-50 dark:bg-charcoal-950">
        <div className="container-custom text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Hassan Alaoui */}
            <motion.div className="card overflow-hidden" whileHover={{ y: -5 }}>
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-charcoal-800 dark:text-cream-50">
                  Hassan Alaoui
                </h3>
                <p className="text-avocado-600 dark:text-avocado-400 mb-3">
                  {t("about.team.ceo")}
                </p>
                <p className="text-charcoal-600 dark:text-cream-300">
