...
const HomePage: React.FC = () => {
  ...
  return (
    <div>
      ...
      <section
        id="about"
        className="py-20 full-height-section bg-cream-50 dark:bg-charcoal-900"
      >
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Quality */}
            <motion.div className="card p-6" whileHover={{ y: -5 }}>
              ...
              <p className="text-charcoal-600 dark:text-cream-300">
                Our avocados are carefully harvested at peak ripeness and
                undergo rigorous quality control before export.
              </p>
            </motion.div>
            ...
            <motion.div className="card p-6" whileHover={{ y: -5 }}>
              ...
              <p className="text-charcoal-600 dark:text-cream-300">
                We employ sustainable farming methods that conserve water,
                protect soil health, and support biodiversity.
              </p>
            </motion.div>
            ...
            <motion.div className="card p-6" whileHover={{ y: -5 }}>
              ...
              <p className="text-charcoal-600 dark:text-cream-300">
                Our products meet international standards with certifications
                including Organic, GlobalG.A.P, and BRC Food Safety.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      {/* Product Showcase */}
      <section className="py-20 full-height-section bg-white dark:bg-charcoal-950 relative overflow-hidden">
      ...
      <section className="py-20 full-height-section bg-avocado-50">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-charcoal-800 text-4xl font-bold mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="w-full max-h-[500px] overflow-hidden rounded-lg shadow-lg">
              <img
